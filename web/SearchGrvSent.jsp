...
<html>
    ...
    <body>
       ...
       <h2><font color="purple">PGO REMINDER SENT</font></h2>
    <div style="margin-top: -50px;margin-left: 500px;width: 200px;float: left">
        <form action="SearchGrvSent.jsp" name="SearchGrvSent" method="post" >
  ...
  <tr>
    <td colspan="3"><strong>REMINDER SENT:</strong></td>
  </tr>
  <tr>
    <td width="123">DATE SENT</td>
    <td width="171">GRIEVANCE REGISTRATION NO</td>
    <td width="385">SENT TO</td>
  </tr>
  ...
  String pgo_regd_id=(String)session.getAttribute("pgo_regd_id");
    ...
    String sql="select * from reminder_box where sent_by_pgo=? and grv_regd_id=? ";
  ...
  <tr>
    ...
    <td><a href="PgoReminderContent.jsp?rem_id=<%=rem_id%>"><%=sent_to_pgo%>-<%=pgo_name%>-<%=designation%></a></br><%=sent_to_org%>-<%=govt_dept%></br><%=dist%>-<%=block%></td>
  </tr>
  <%}}%>
  <tr>
