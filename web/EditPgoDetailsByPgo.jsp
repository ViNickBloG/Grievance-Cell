...
$(function () {
  ...
  <script type="text/javascript">
    ...
    if (rs2.next())
    {
        ...
        <form action="UpdatePgoDetailsByPgo" method="post" onsubmit="return checkForm(this)">
  ...
  <table width="515" border="1" class="table1">
   ...
   <tr>
    ...
    <tr>
      <td>PASSWORD</td>
      <td><label>
        <input type="password" name="password" id="textfield5" value="<%=password%>"/>
      </label></td>
    </tr>
    <tr>
      <td>Confirm Password</td>
      <td><label>
        <input type="password" name="confirm_pwd" id="textfield6" value="<%=password%>"/>
      </label></td>
    </tr>
    <tr>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;       </td>
