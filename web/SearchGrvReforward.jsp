...
<html>
    ...
    <div style="margin-top: -50px;margin-left: 500px;width: 200px;float: left">
        <form action="SearchGrvReforward.jsp" name="SearchGrvReforward" method="post" >
  ...
  <tr>
    <th colspan="7" scope="col"><em><u>REFORWARDED GRIEVANCE</u></em></th>
  </tr>
  <tr>
    <td width="100">DATE OF REFORWARDING</td>
    <td width="100">DATE OF RETURN</td>
    <td width="100">DATE OF REGISTRATION</td>
    <td width="100">TARGET DATE</td>
 ...
 Connection con = new DBConnection().getConnection();   
  ...
  String sql3="select * from reforward_grv where pgo_regd_id=? and grv_regd_id=?";
