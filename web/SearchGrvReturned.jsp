...
<html>
    ...
    <div style="margin-top: -50px;margin-left: 500px;width: 200px;float: left">
        <form action="SearchGrvReturned.jsp" name="SearchGrvReturned" method="post" >
  ...
  <tr>
    <th colspan="9" scope="col"><em><u>RETURNED GRIEVANCE</u></em></th>
  </tr>
  <tr>
    <td width="50">DATE OF RETURN</td>
    <td width="50">DATE OF REGISTARTION</td>
    <td width="50">GRV REGD ID</td>
    
    <td width="50">TARGET DATE</td>
    <td width="100">NAME OF COMPLAINANT</td>
    <td width="100">REMARKS</td>
    <td width="100">SUGGESTED ORGANIZATION</td>
    <td width="100">REFORWARD</td>
    <td width="100">MAKE THIS NEW GRIEVANCE</td>
  </tr>
  ...
  String org_id=(String)session.getAttribute("org_id");
    ...
    String sql="select gr.*,ur.name,gs.grv_regd_id from grv_regd gr join user_regd ur on(gr.user_regd_id=ur.user_regd_id) join grv_status gs on (gr.grv_regd_id=gs.grv_regd_id)  where gs.status='Returned' and gs.received_by=? and gr.grv_regd_id=?";
