...
<html>
    ...
    <body>
        ...
        <h2><font color="purple">CLARIFICATION RECEIVED</font></h2>
     <div style="margin-top: -50px;margin-left: 500px;width: 200px;float: left">    <form action="SearchGrvPgoClarReceived.jsp" name="SearchGrvPgoClarReceived" method="post" >
   ...
   <table width="700" height="100" border="1" class="table1">
    <tr>
    <th width="100">DATE RECEIVED</td>
    <th width="100">GRIEVANCE REGISTRATION NO</td>
    <th width="300"><div align="center">SENDER</div></td>
    <th width="200">SHOW LETTER/REPLY TO LETTER</td>
  ...
  String org_id=(String)session.getAttribute("org_id");
    ...
    String sql="select * from clarification_box where sent_to_pgo=?  ";
