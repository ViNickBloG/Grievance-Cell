...
<html>
    ...
    <div style="margin-top: -50px;margin-left: 500px;width: 200px;float: left">    <form action="SearchGrvCaseReport.jsp" name="SearchGrvCaseReport" method="post" >
  ...
  String pgo_regd_id=(String)session.getAttribute("pgo_regd_id");
    ...
    String sql="select gr.*,cr.* from grv_regd gr join case_report cr on(gr.grv_regd_id=cr.grv_regd_id)  where cr.sentto_pgo=?  ";
