...
<html>
    ...
    <%}%>
        ...
        <div style="margin-top: -50px;margin-left: 500px;width: 200px;float: left"><form action="SearchGrv.jsp" name="SearchGrv" method="post" >
  ...
  <tr>
    <th height="73" scope="col">GRIEVANCE REGISTRATION NO</th>
          ...
          String sql2="select decision from grv_action where action_taken_by=? and grv_regd_id=?";
           PreparedStatement ps2 = con.prepareStatement(sql2);
            ...
            if(rs2.next())
            {
                ...
                if(ctype!=null && ctype.equals("examine"))
               {
