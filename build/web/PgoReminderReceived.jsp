...
<html>
    ...
    <body>
        ...
        <h2><font color="purple">REMINDER RECEIVED</font></h2>
     <div style="margin-top: -50px;margin-left: 500px;width: 200px;float: left">    <form action="SearchGrvReminder.jsp" name="SearchGrvReminder" method="post" >
       ...
       <input name="submit" type="submit" value="" class="searchbtn"/>
        ...
        <table width="701" height="100" border="1" class="table1">
  
  <tr>
    <th>DATE RECEIVED</td>
    <th>GRIEVANCE REGISTRATION NO</td>
    <th>SENDER</td>
  </tr>
  <%
  String pgo_regd_id=(String)session.getAttribute("pgo_regd_id");
    Connection con = new DBConnection().getConnection();   
    String sql="select * from reminder_box where sent_to_pgo=?  ";
