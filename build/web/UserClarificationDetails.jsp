<%-- 
    Document   : UserClarification
    Created on : 4 Dec, 2012, 5:20:40 PM
    Author     : USER
--%>
...
<html>
    ...
    <body>
        ...
        <%String clarification_id=request.getParameter("clarification_id");
         ...
         String reply_sent_by_user=(String)session.getAttribute("user_regd_id");
  ...
  <tr>
    <th width="100">LETTER <br />(PLEASE CLARIFY ABOUT <br />
        THIS TOPIC :):</th>
...
<table width="600" height="200" border="5">
  <tr>
    <th width="100">WRITE REPLY <br />(WRITE YOUR CLARIFICATION <br />
      TO THE ABOVE ISSUE HERE :)</th>
    <% if(reply123==null || reply123.equals("")){%>
    <td width="400">
        <input type="hidden" name="reply_sent_by_user" id="textfield" value="<%=reply_sent_by_user%>">
  ...
  <tr>
    ...
    <td colspan="2"><label>
            <div align="right">
      <a href="UserClarification.jsp">BACK</a>
            </div>
    </label></td>
    <%}%>
