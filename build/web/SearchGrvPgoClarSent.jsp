...
<html>
    ...
    <body>
        ...
        <h2><font color="purple">PGO CLARIFICATION SENT</font></h2>
    <div style="margin-top: -50px;margin-left: 500px;width: 200px;float: left">
        <form action="SearchGrvPgoClarSent.jsp" name="SearchGrvPgoClarSent" method="post" >
  ...
  <tr>
    <td colspan="4"><strong>LETTER SENT:</strong></td>
  </tr>
  <tr>
    <td width="100">DATE SENT</td>
    <td width="100">GRIEVANCE REGISTRATION NO</td>
    <td width="300"><div align="center">SENT TO</div></td>
    <td width="200">SHOW LETTER/SHOW REPLY</td>
  ...
  String org_id=(String)session.getAttribute("org_id");
    ...
    String sql="select * from clarification_box where sent_by_pgo=? and grv_regd_id=?  ";
