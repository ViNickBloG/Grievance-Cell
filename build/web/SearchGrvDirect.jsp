...
<html>
    ...
    <%}%>
    <h2><font color="purple">DIRECT ACTION TAKEN GRIEVANCE</font></h2>
  ...
  String pgo_regd_id=(String)session.getAttribute("pgo_regd_id");
    ...
    String sql="select gr.*,dp.*,da.* from grv_regd gr join grv_disposed dp on(gr.grv_regd_id=dp.grv_regd_id)join direct_action da on(gr.grv_regd_id=da.grv_regd_id) where dp.status='Disposed' and gr.direct_action='Yes' and disposed_by=? and gr.grv_regd_id=?";
