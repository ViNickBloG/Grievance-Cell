...
<html>
    ...
    <body>
        ...
        <div style="margin-top: -50px;margin-left: 500px;width: 200px;float: left"><form action="SearchGrvAction.jsp" name="SearchGrvAction" method="post" >
        ...
        <%
            ...
            String sql="select * from grv_action ";
        ...
        <% 
        String sql1="select * from grv_pending_action ";
